...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(modkandinsky_fill_triangle_obj, 7, 9, modkandinsky_fill_triangle);
...
STATIC const mp_rom_map_elem_t modkandinsky_module_globals_table[] = {
  ...
  { MP_ROM_QSTR(MP_QSTR_fill_triangle), (mp_obj_t)&modkandinsky_fill_triangle_obj },
};
